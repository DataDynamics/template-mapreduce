...
public class FileSelectorChain implements io.datadynamics.bigdata.mapreduce.util.FileSelector {
     ...
     * File Selector 목록
     */
    private List<io.datadynamics.bigdata.mapreduce.util.FileSelector> fileSelectors;
    ...
    public String getTargetHdfs(String filename) {
        for (Iterator<io.datadynamics.bigdata.mapreduce.util.FileSelector> fileSelectorIterator = fileSelectors.iterator(); fileSelectorIterator.hasNext(); ) {
            io.datadynamics.bigdata.mapreduce.util.FileSelector fileSelector = fileSelectorIterator.next();
     ...
     */
    public void setFileSelectors(List<io.datadynamics.bigdata.mapreduce.util.FileSelector> fileSelectors) {
